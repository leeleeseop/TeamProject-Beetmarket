...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- 이벤트 -->
			<li class="nav-item"><a class="nav-link event" href="/event/list.do" style="color:white;">
				<span>이벤트</span>
			</a></li>
			...
			<!-- 공지사항  -->
			<li class="nav-item"><a class="nav-link notice" href="/notice/list.do" style="color:white;"> 
				<span>공지사항</span>
			</a></li>
						...
						<c:if test="${!empty login}">
							<div class="nav-item dropdown" >
								<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
									...
									<!-- sassaas -->
										<a class="dropdown-item" href="/member/myView.do">내정보보기</a>
										<a class="dropdown-item" href="/basket/list.do">장바구니</a>
										<a href="/order/list.do" class="dropdown-item">주문내역</a>
										<a href="/chatbot/roomlist.do" class="dropdown-item">채팅방</a>
									</div>
								</div>
